...
<div class="max-w-5xl space-y-6">
    ...
    <div class="flex justify-between items-start">
        ...
        <div class="flex gap-2">
            <a href="{{ route('clientes.edit', $cliente) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold py-2 px-4 rounded-lg transition flex items-center gap-2">
                ...
                @if($cliente->sedes->count() > 0)
                    <div class="space-y-2">
                        @foreach($cliente->sedes->take(5) as $sede)
                            <a href="{{ route('sedes.show', $sede) }}" class="block p-2 hover:bg-gray-100 rounded-lg transition">
    ...
    <div class="flex justify-between">
        <a href="{{ route('clientes.index') }}" class="text-blue-600 hover:text-blue-900 flex items-center gap-2">
