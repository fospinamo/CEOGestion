...
@section('page-description', 'Modificar datos del usuario')
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white shadow-md rounded-lg p-6">
        ...
        <form action="{{ route('seguridad.usuarios.update', $usuario) }}" method="POST" class="space-y-4">
            @csrf
            @method('PUT')
            ...
            <!-- Contraseña -->
            <div>
                <label for="password" class="block text-sm font-semibold text-gray-700 mb-1">Contraseña (dejar en blanco para no cambiar)</label>
                <input type="password" name="password" id="password" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500" minlength="8">
            ...
            <div>
                ...
                <input type="password" name="password_confirmation" id="password_confirmation" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500" minlength="8">
            </div>
            ...
            <div class="flex items-center gap-2">
                <input type="checkbox" name="estado" id="estado" value="1" class="rounded" 
