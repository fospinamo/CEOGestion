        ...
        <div class="bg-white rounded-lg shadow p-6 space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="valor_contrato" value="{{ old('valor_contrato', $contrato->valor_contrato) }}" step="0.01" min="0" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 @error('valor_contrato') border-red-500 @enderror" required placeholder="0.00">
                ...
                <div>
                    ...
                    <select name="moneda" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 @error('moneda') border-red-500 @enderror" required>
                        ...
                        <option value="COP" {{ old('moneda', $contrato->moneda) == 'COP' ? 'selected' : '' }}>COP (Pesos Colombianos)</option>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="flex items-end">
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="documento_firmado" value="1" {{ old('documento_firmado', $contrato->documento_firmado) ? 'checked' : '' }} class="w-4 h-4 text-blue-600 rounded focus:ring-2 focus:ring-blue-500">
                ...
                <div class="flex items-end">
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="renovacion_automatica" value="1" {{ old('renovacion_automatica', $contrato->renovacion_automatica) ? 'checked' : '' }} class="w-4 h-4 text-blue-600 rounded focus:ring-2 focus:ring-blue-500">
