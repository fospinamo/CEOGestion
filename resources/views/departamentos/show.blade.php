...
<div class="space-y-6">
            ...
            <div class="divide-y divide-gray-200">
                @foreach($departamento->municipios as $municipio)
                    <div class="p-4 hover:bg-gray-50 transition flex justify-between items-center">
                        ...
                        <a href="{{ route('municipios.show', $municipio) }}" class="text-blue-600 hover:text-blue-900 transition">
    ...
    <!-- Back Button -->
    <div>
        <a href="{{ route('departamentos.index') }}" class="inline-flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition">
