...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <form method="GET" action="{{ route('servicios.index') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4">
            <!-- Filtro por Cliente -->
            <div>
            ...
            <div class="flex gap-2 items-end">
                ...
                <a href="{{ route('servicios.index') }}" class="flex-1 bg-gray-500 hover:bg-gray-600 text-white font-semibold py-2 px-4 rounded-lg transition text-center">
                    ↺ Limpiar
                </a>
            </div>
        </form>
            ...
            <tbody class="divide-y">
                @forelse($servicios as $servicio)
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-6 py-3">
                            <a href="{{ route('servicios.show', $servicio) }}" class="text-blue-600 hover:text-blue-900 font-bold">
                                #{{ $servicio->id }}
                            </a>
                        </td>
                        <td class="px-6 py-3">
                        ...
                        <td class="px-6 py-3 text-center">
                            <div class="flex justify-center gap-2">
                                <a href="{{ route('servicios.show', $servicio) }}" class="text-blue-600 hover:text-blue-900 font-bold" title="Ver">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('servicios.edit', $servicio) }}" class="text-yellow-600 hover:text-yellow-900 font-bold" title="Editar">
                                    <i class="fas fa-edit"></i>
                                </a>
                                @if($servicio->persona_receptora_nombre)
                                    <a href="{{ route('servicios.download-informe-pdf', $servicio) }}" class="text-red-600 hover:text-red-900 font-bold" title="Descargar PDF">
                                        <i class="fas fa-file-pdf"></i>
                                    </a>
                                @endif
                                @if(!$servicio->tecnico_id)
                                    <a href="{{ route('servicios.assign', $servicio) }}" class="text-green-600 hover:text-green-900 font-bold" title="Asignar Técnico">
