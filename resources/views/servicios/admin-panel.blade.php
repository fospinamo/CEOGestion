                    ...
                    @forelse($tecnico->servicios as $servicio)
                        <div class="bg-white rounded-lg border-2 p-4" style="border-color: {{ $servicio->estadoServicio->color ?? '#e5e7eb' }};">
                            ...
                            <div class="flex gap-2 flex-wrap">
                                <a href="{{ route('servicios.show', $servicio) }}" class="flex-1 min-w-[80px] px-2 py-1 bg-blue-100 text-blue-800 rounded text-center text-xs font-semibold hover:bg-blue-200 transition">
                                    Ver
                                </a>
                                <a href="{{ route('servicios.edit', $servicio) }}" class="flex-1 min-w-[80px] px-2 py-1 bg-yellow-100 text-yellow-800 rounded text-center text-xs font-semibold hover:bg-yellow-200 transition">
                                    Editar
                                </a>
                                @if($servicio->persona_receptora_nombre)
                                    <a href="{{ route('servicios.download-informe-pdf', $servicio) }}" class="flex-1 min-w-[80px] px-2 py-1 bg-red-100 text-red-800 rounded text-center text-xs font-semibold hover:bg-red-200 transition">
                                        PDF
                                    </a>
                                @endif
                            </div>
