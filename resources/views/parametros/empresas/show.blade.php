...
<div class="grid grid-cols-3 gap-6">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="space-y-2">
                <a href="{{ route('parametros.empresas.edit', $empresa) }}" class="block px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition text-center">
                    <i class="fas fa-edit mr-2"></i> Editar
                </a>
                <form action="{{ route('parametros.empresas.destroy', $empresa) }}" method="POST" onsubmit="return confirm('¿Estás seguro?')">
                    @csrf
                    @method('DELETE')
                ...
                <a href="{{ route('parametros.empresas.index') }}" class="block px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition text-center">
