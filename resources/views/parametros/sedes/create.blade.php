...
<div class="max-w-4xl">
    <div class="bg-white rounded-lg shadow">
        <form action="{{ route('parametros.sedes.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
...
<script>
console.log('🔍 Inicializando cascada de sedes...');
...
console.log('✅ Script de cascada cargado correctamente');
</script>
@endsection
