...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <a href="{{ route('departamentos.show', $municipio->departamento) }}" class="text-xl font-bold text-blue-600 hover:underline">
    ...
    <!-- Back Button -->
    <div>
        <a href="{{ route('municipios.index') }}" class="inline-flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition">
