...
<div class="grid grid-cols-3 gap-6">
    ...
    <div class="space-y-6">
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="space-y-2">
                <a href="{{ route('equipos.edit', $equipo) }}" class="block px-4 py-2 bg-yellow-100 text-yellow-800 rounded hover:bg-yellow-200 transition text-center text-sm font-semibold">
                    <i class="fas fa-edit mr-2"></i> Editar
                </a>
                <form action="{{ route('equipos.destroy', $equipo) }}" method="POST" onsubmit="return confirm('¿Eliminar equipo?')">
                    @csrf @method('DELETE')
