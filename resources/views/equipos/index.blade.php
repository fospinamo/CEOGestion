...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow p-6 border-l-4 border-blue-500">
        <form method="GET" action="{{ route('equipos.index') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4">
            <!-- Filtro por Empresa -->
            <div>
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="{{ route('equipos.index') }}" class="flex-1 bg-gray-500 hover:bg-gray-600 text-white font-semibold py-2 px-4 rounded-lg transition flex items-center justify-center gap-2">
    ...
    <div class="flex gap-2">
        <a href="{{ route('equipos.exportar.excel', request()->query()) }}" class="bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded-lg transition flex items-center gap-2">
            <i class="fas fa-file-excel"></i> Descargar Excel
        </a>
        <a href="{{ route('equipos.exportar.pdf', request()->query()) }}" class="bg-red-600 hover:bg-red-700 text-white font-semibold py-2 px-4 rounded-lg transition flex items-center gap-2">
