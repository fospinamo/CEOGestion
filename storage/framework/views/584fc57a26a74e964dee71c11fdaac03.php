...
<?php $__env->startSection('page-description', 'Estadísticas y métricas de gestión'); ?>

<?php $__env->startSection('content'); ?>
<div class="space-y-6">
    <!-- Panel rápido del técnico -->
    <?php if(auth()->check() && auth()->user()->tipo_rol === 'tecnico'): ?>
    <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-lg shadow-lg p-8 text-white">
        <div class="flex justify-between items-center">
            ...
            <a href="<?php echo e(route('incidencias.servicios.technician-panel')); ?>" 
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
            <div class="flex-1 mr-4">
                ...
                <form method="GET" action="<?php echo e(route('home')); ?>" class="flex gap-3">
                    <select name="empresa_id" onchange="this.form.submit()" 
                        ...
                        <?php $__currentLoopData = $empresas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($emp->id); ?>" <?php echo e($emp->id === $dashboard['empresa']?->id ? 'selected' : ''); ?>>
            ...
            <?php if($dashboard['empresa']): ?>
            <div class="text-right">
                <p class="text-sm text-gray-600">Empresa Seleccionada</p>
                <p class="text-lg font-bold text-blue-600"><?php echo e($dashboard['empresa']->nombre); ?></p>
            </div>
            <?php endif; ?>
        </div>
    </div>
        ...
        <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg shadow p-6 border-l-4 border-blue-600">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-4xl font-bold text-blue-600"><?php echo e($dashboard['clientes']); ?></p>
                </div>
        ...
        <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-lg shadow p-6 border-l-4 border-green-600">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-4xl font-bold text-green-600"><?php echo e($dashboard['contratos_vigentes']); ?></p>
                </div>
        ...
        <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg shadow p-6 border-l-4 border-purple-600">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-4xl font-bold text-purple-600"><?php echo e($dashboard['equipos_totales']); ?></p>
                </div>
        ...
        <div class="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg shadow p-6 border-l-4 border-orange-600">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-4xl font-bold text-orange-600"><?php echo e($dashboard['incidencias_totales']); ?></p>
                </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <p class="text-3xl font-bold text-blue-600">
                        $<?php echo e(number_format($dashboard['valor_total_contratos'], 2, ',', '.')); ?>
                ...
                <div class="border-t pt-4">
                    ...
                    <p class="text-2xl font-bold text-green-600">
                        $<?php echo e(number_format($dashboard['pago_mensual'], 2, ',', '.')); ?>
        ...
        <?php if($dashboard['contratos_vigentes'] > 0): ?>
        <div class="bg-white rounded-lg shadow p-6 border-t-4 border-green-500">
            ...
            <div class="space-y-3">
                <div class="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                    ...
                    <span class="text-2xl font-bold text-blue-600"><?php echo e($dashboard['contratos_vigentes']); ?></span>
                </div>
                <div class="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
                    <span class="text-gray-700 font-semibold">Promedio por Contrato</span>
                    <span class="text-xl font-bold text-purple-600">
                        $<?php echo e(number_format($dashboard['valor_total_contratos'] / $dashboard['contratos_vigentes'], 2, ',', '.')); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <?php if(count($dashboard['incidencias_por_estado']) > 0): ?>
            <div class="space-y-3">
                <?php
                    $colores = [
                ...
                ?>
                <?php $__currentLoopData = $dashboard['incidencias_por_estado']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estado => $cantidad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex items-center justify-between p-3 border rounded-lg <?php echo e($colores[$estado] ?? 'bg-gray-50'); ?>">
                    <div class="flex items-center gap-2">
                        <i class="fas <?php echo e($iconos[$estado] ?? 'fa-info'); ?>"></i>
                        <span class="font-semibold"><?php echo e($estado); ?></span>
                    </div>
                    <span class="text-2xl font-bold"><?php echo e($cantidad); ?></span>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <?php else: ?>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <?php if(count($dashboard['incidencias_por_año']) > 0): ?>
            <div class="space-y-3">
                <?php
                    $años = collect($dashboard['incidencias_por_año'])->sortKeysDesc();
                ?>
                <?php $__currentLoopData = $años; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $año => $cantidad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex items-center justify-between p-3 bg-indigo-50 border border-indigo-300 rounded-lg">
                    <span class="font-semibold text-gray-700">Año <?php echo e($año); ?></span>
                    <span class="text-2xl font-bold text-indigo-600"><?php echo e($cantidad); ?></span>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <?php else: ?>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <?php if(count($dashboard['incidencias_por_mes']) > 0): ?>
        <div class="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-12 gap-2">
            ...
            ?>
            <?php $__currentLoopData = $dashboard['incidencias_por_mes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mes => $cantidad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            <div class="flex flex-col items-center">
                <div class="w-full bg-gray-200 rounded-t-lg overflow-hidden" style="height: 150px;">
                    <div class="bg-blue-500 w-full rounded-t-lg transition-all hover:bg-blue-600" 
                        style="height: <?php echo e($porcentaje); ?>%; position: relative;">
                        <?php if($cantidad > 0): ?>
                ...
                <p class="text-xs font-semibold text-gray-700 mt-2"><?php echo e($nombreMes); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <?php else: ?>
    ...
    <div class="grid grid-cols-2 gap-6">
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="space-y-2">
                <a href="<?php echo e(url('parametros/contratos')); ?>" class="block px-4 py-2 bg-blue-50 text-blue-700 rounded-lg hover:bg-blue-100 transition flex items-center gap-2">
                    <i class="fas fa-file-contract"></i> Ver Contratos
                </a>
                <a href="<?php echo e(url('parametros/clientes')); ?>" class="block px-4 py-2 bg-green-50 text-green-700 rounded-lg hover:bg-green-100 transition flex items-center gap-2">
                    <i class="fas fa-users"></i> Ver Clientes
                </a>
                <a href="<?php echo e(url('parametros/equipos')); ?>" class="block px-4 py-2 bg-purple-50 text-purple-700 rounded-lg hover:bg-purple-100 transition flex items-center gap-2">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="space-y-2">
                <a href="<?php echo e(url('incidencias/servicios')); ?>" class="block px-4 py-2 bg-orange-50 text-orange-700 rounded-lg hover:bg-orange-100 transition flex items-center gap-2 justify-between">
                    <span>Ver Incidencias</span>
                    <i class="fas fa-arrow-right"></i>
                </a>
                <a href="<?php echo e(url('parametros/empresas')); ?>" class="block px-4 py-2 bg-gray-50 text-gray-700 rounded-lg hover:bg-gray-100 transition flex items-center gap-2 justify-between">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\CEOGestion\resources\views/home.blade.php ENDPATH**/ ?>