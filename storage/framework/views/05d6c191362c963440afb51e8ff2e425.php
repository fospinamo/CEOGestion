...
<?php $__env->startSection('title', $equipo ? 'Editar Equipo' : 'Nuevo Equipo'); ?>
<?php $__env->startSection('page-title', $equipo ? 'Editar Equipo' : 'Registrar Nuevo Equipo'); ?>
<?php $__env->startSection('page-description', $equipo ? 'Actualizar equipo TI' : 'Agregar equipo a inventario'); ?>
        ...
        <div class="border-b pb-6">
                ...
                <div>
                    ...
                    <select id="empresa_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500">
                        ...
                        <?php $__currentLoopData = $empresas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empresa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($empresa->id); ?>" <?php echo e($equipo && $equipo->area->sede->empresa_id == $empresa->id ? 'selected' : ''); ?>>
                ...
                <div>
                    ...
                    <select id="cliente_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500">
                        ...
                        <?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($cliente->id); ?>" <?php echo e($equipo && $equipo->area->sede->cliente_id == $cliente->id ? 'selected' : ''); ?>>
            ...
            <div class="grid grid-cols-3 gap-4">
                <div>
                    ...
                    <select id="sede_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 <?php $__errorArgs = ['sede_id'];
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <?php $__currentLoopData = $sedes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sede): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($sede->id); ?>" 
                                ...
                                <?php echo e($equipo && $equipo->area->sede_id == $sede->id ? 'selected' : ''); ?>>
        ...
        <div class="border-b pb-6">
            ...
            <div class="grid grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="codigo_interno" value="<?php echo e(old('codigo_interno', $equipo->codigo_interno ?? '')); ?>" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 <?php $__errorArgs = ['codigo_interno'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
        ...
        <div class="border-b pb-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="marca" value="<?php echo e(old('marca', $equipo->marca ?? '')); ?>" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 <?php $__errorArgs = ['marca'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\CEOGestion\resources\views/parametros/equipos/create.blade.php ENDPATH**/ ?>