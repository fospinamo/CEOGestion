        ...
        <div class="bg-blue-50 border-l-4 border-blue-500 p-6 mb-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <p class="text-lg font-semibold">#<?php echo e($servicio->id); ?></p>
                </div>
                <div>
                    <p class="text-sm text-gray-600">Equipo</p>
                    <p class="text-lg font-semibold"><?php echo e($servicio->equipo->codigo_interno); ?></p>
                </div>
                <div>
                    <p class="text-sm text-gray-600">Cliente</p>
                    <p class="text-lg font-semibold"><?php echo e($servicio->equipo->area->sede->cliente->razon_social); ?></p>
                </div>
                <div>
                    <p class="text-sm text-gray-600">Tipo de Servicio</p>
                    <p class="text-lg font-semibold"><?php echo e($servicio->tipo_servicio); ?></p>
                </div>
                <div class="md:col-span-2">
                    <p class="text-sm text-gray-600">Problema</p>
                    <p class="text-lg font-semibold"><?php echo e(substr($servicio->descripcion_problema, 0, 100)); ?>...</p>
                </div>
            </div>
        </div>

        <!-- Formulario de Asignación -->
        <form action="<?php echo e(route('incidencias.servicios.store-assign', $servicio)); ?>" method="POST" class="bg-white shadow-lg rounded-lg p-8">
            <?php echo csrf_field(); ?>
                    ...
                    <select name="tecnico_id" id="tecnico_id" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        ...
                        <?php $__currentLoopData = $tecnicos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tecnico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($tecnico->id); ?>" 
                                <?php if($servicio->tecnico_id === $tecnico->id): ?> selected <?php endif; ?>>
                                <?php echo e($tecnico->name); ?> 
                                <?php if($tecnico->telefono): ?> (<?php echo e($tecnico->telefono); ?>) <?php endif; ?>
                            </option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="datetime-local" name="fecha_asignacion" id="fecha_asignacion" 
                        ...
                        value="<?php echo e(old('fecha_asignacion', $servicio->fecha_asignacion?->format('Y-m-d\\TH:i') ?? now()->format('Y-m-d\\TH:i'))); ?>"
                        required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                    <label class="inline-flex items-center gap-2 text-sm font-semibold text-green-900">
                        <input type="checkbox" name="enviar_whatsapp" value="1" class="rounded border-green-400 text-green-600" <?php echo e(old('enviar_whatsapp', '1') ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\CEOGestion\resources\views/incidencias/servicios/assign.blade.php ENDPATH**/ ?>