            ...
            <tbody class="divide-y">
                <?php $__empty_1 = true; $__currentLoopData = $equipos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-6 py-3">
                            <p class="font-semibold text-gray-900"><?php echo e($equipo->codigo_interno); ?></p>
                        ...
                        <td class="px-6 py-3">
                            <p class="text-sm text-gray-900"><?php echo e($equipo->marca); ?> <?php echo e($equipo->modelo); ?></p>
